...
public class ServicioPrimoBroadcast extends Fragment {
    ...
    private ServicioPrimoBroadcast.DigestReceiver mReceiver = new ServicioPrimoBroadcast.DigestReceiver();
    ...
    private static class DigestReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if ( view != null ) {
                String result = intent.getStringExtra(PrimoServiceBroadcast.RESULT);
                view.setText(result);
            } else {
                Log.i("PrimoServiceBroadcast", " ignoring - we're detached");
            }
        }
    ...
    */
    ...
    public void onStart() {
        super.onStart();
        Intent intent = new Intent(getActivity(), PrimoServiceBroadcast.class);
        getActivity().bindService(intent, mConnection, Context.BIND_AUTO_CREATE);
        mReceiver.attach(resultField);
        IntentFilter filter = new IntentFilter(
                PrimoServiceBroadcast.PRIMO_BROADCAST);
    ...
    private ServiceConnection mConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            PrimoServiceBroadcast.LocalBinder binder = (PrimoServiceBroadcast.LocalBinder) service;
